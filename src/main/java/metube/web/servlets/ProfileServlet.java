...
import metube.domein.models.views.UserProfileViewModel;
...
public class ProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        UserProfileViewModel userProfileViewModel = this.modelMapper
                .map(this.userService.findUserByName((String)
                        req.getSession().getAttribute("username")), UserProfileViewModel.class);
